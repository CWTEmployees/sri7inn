<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Rooms.aspx.cs" Inherits="sree7.Rooms" %>
                    ...
                    <div style="visibility: display">
                        <div class="header-right">
                            ...
                            <div class="call-us clearfix">
                                ...
                                <a tabindex="-2" href="tel:+91 998 519 9522">+91 998 519 9522</a>
                            </div>
                ...
                <div class="main-page">
                    ...
                    <div class="clearfix">
                        <div class="main-content">
                            ...
                            <asp:DataList ID="DL" runat="server" Width="800px">
                                <ItemTemplate>
                                    <div class=" room_selection room-selection">
                                        <input type="hidden" class="room_count" name="room_count" value="0">
                                        <div class="room-type-section room_type_section clearfix " data-room-type="1">
                                            <div class="clearfix rooms-wrapper" style="margin-bottom: 80px;">
                                                <div class="room-type-img-wrap clearfix">
                                                    <div class="room-img-caption-wrap">
                                                        <div class="room-type-img">

                                                            <a href="SuitRoom.aspx?id=<%#Eval("Room_Id") %>">
                                                                <asp:Image ID="Image1" runat="server" Height="130px" ImageUrl='<%# Eval("ImagePath") %>' Width="120px" />
                                                                <%--<img data-room-type-gallery="1" data-image-id='0' src="public/img/about_back.jpg" alt="" title="" style="margin-top: 80px;" />--%>
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="room-type-title-wrap" style="margin-top: 80px;">
                                                        <strong>
                                                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("Room_Type") %>'></asp:Label></strong>
                                                        <span class="room-type-info room_type_info "><span class="min_price">
                                                            <h4><font color="#2BB96E"><b>
                                                                <asp:Label ID="Label3" runat="server" Text='<%# Eval("availablerooms") %>'></asp:Label> Rooms Left
                                                                                      </b></font></h4>
                                                        </span></span>
                                                        <span class=""><b>Anantapur</b>
                                                            <svg class="icon">
                                                ...
                                                <div class="room-type-price-wrap room_type_night_price ">
                                                    <div class="wrapper coupan-wrapper">
                                                        <div class="room-type-price-wrapper room_type_night_prices ">
                                                            <div class="wrap-price " style="margin-top: 80px;">
                                                                <span class=" ">
                                                                    <span class=""></span>
                                                                </span>
                                                                <span class="save-rupees save_rupees">
                                                                    <button style="background-color: #2BB96E">
                                                                        <h1><b><span style="color: black">4.0/5</span></b></h1>
                                                                    </button>
                                                                </span>
                                                            </div>
                                                            <strong><span class="room-type-price room_type_price"></span>
                                                            </strong>
                                                        </div>
                                                    </div>
                                                    <span class="room-type-info room_type_guests_info ">
                                                        <span class="">
                                                            <br />
                                                            <h4><font color="2BB96E"><h3><b>814 Reviews</b></h3></font>
                                                                <h4></h4>
                                                                <br />
                                                                <br></br>
                                                                <h4></h4>
                                                        ...
                                                        <span class="room_type_nights"></span>
                                                    </span>

                                                    <a href="SuitRoom.aspx?id=<%#Eval("Room_Id") %>">
                                                        <asp:Image ID="Image2" runat="server" Height="50px" Width="90px" ImageUrl="img/book.png" />
                                                        <%--<asp:Button ID="btn1" runat="server" Text="Book" class="btn  btn-primary" Style="padding-left: 50px; padding-right: 50px;" />--%>
                                                        <%--<button class="btn  btn-primary " style="padding-left: 50px; padding-right: 50px;">BOOK</button>--%>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <%--<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:sree7ConnectionString6 %>" SelectCommand="SELECT * FROM [TblRoom]"></asp:SqlDataSource>--%>
                        ...
                        <aside class="sidebar">
                            ...
                            <div class="hospitality-section">
                                ...
                                <div class="hospitality-listing">
                                    <div class="hospitality-pic">
                                        <img src="public/img/QUALITY%20TEAM.jpg" />
                                    </div>
                                    <div class="hospitality-content">
