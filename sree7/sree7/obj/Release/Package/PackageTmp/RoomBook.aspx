                ...
                <div class="col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
							...
							<thead>
								<tr align="Center" style="background: #258BB1; color: #fff; font-size: 18px;">
									<td>S.No.</td>
									<td>Images</td>
									<td>Room Type</td>
									<td>Room Id</td>
							...
							<tbody>
								<tr align="Center">
                                    <td class="thead_td"><label>1</label></td>
                                    <td><label><img src="img/room.jpg" width="150" height="130"></label></td>
                                    <td class="thead_td"><label>Suite Room</label></td>
                                    <td class="thead_td"><label>1</label></td>
                                    <td class="thead_td"><label>1</label></td>
                                        <td class="thead_td"><label><i class="fa fa-inr" aria-hidden="true"></i>2000</label></td>
                                    <td class="thead_td"><label>2</label></td>
                                    <td class="thead_td"><label><i class="fa fa-inr" aria-hidden="true"></i>12000</label></td>
                                    <td class="thead_td"><label><a href="guests.html">Edit</a></label></td>
                                    <td class="thead_td"><label><a href="#">Remove</a></label></td>
								</tr>
								<tr align="Center" style="color: #258BB1; font-size: 18px;"><td colspan="10">Total Amount  &nbsp;&nbsp;<i class="fa fa-inr" aria-hidden="true"></i>12000</td></tr>

							</tbody>
						</table>--%>
                                </div>
                                <br />
                                <%--<button class="btn btn-continue" id="button" style="margin-left: 40px;">Continue</button>--%>
                                <br />
                                <br />
                            ...
                            <div class="body">
                                ...
                                <form id="user_details" method="post" name="form" action="payment.html">
				  				...
				  				<input type="checkbox" required="true">
                                    ...
                                    <br />
                                    <div class="col-xs-4">
                                        <asp:LinkButton runat="server" class="btn btn-continue" ID="booking_info" Style="margin-top: 15px;" OnClick="booking_info_Click" Text="Proceed To Pay"></asp:LinkButton>
