<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserProfile.aspx.cs" Inherits="sree7.UserProfile" %>
                    ...
                    <div class="container">
                        <nav class="navbar navbar-default">
                            <div class="navbar-header navbar-left">
                                <a href="Home.aspx">
                                    <img src="img/final_logo2.png" width="150" height="50" />
                                </a>
                            </div>
                    ...
                    <aside class="sidebar">
                        <nav class="tabs">
                            <ul class="clearfix sidebar_tabs">
                                <li><a href="MyBookings.aspx" class="sidebar_inner_tab bookings_tab">Bookings </a></li>
                                <li><a href="UserProfile.aspx" class="active-tab sidebar_inner_tab">Profile </a></li>
                            </ul>
                        </nav>
                    </aside>
                    <div class="booking-container bookings_parent_container">
                        <form>
                            <div class="my-profile profile_container">
                                <div class="profile-wrapper">
                                    <div class="edit_my_profile" data-updateprofile-url="/user/UpdateUserProfile">
                                        <div class="error_info"></div>
                                        <div class="form-wrap input_wrap user_name_container">
                                            <label>First Name</label>
                                            <asp:Label ID="lblFirstName" runat="server" class="user_name" TabIndex="1" placeholder="eg. Tom"></asp:Label>
                                            <asp:TextBox ID="txtFirstName" runat="server" class="user_name" TabIndex="1" placeholder="First Name"></asp:TextBox>

                                        </div>
                                        <div class="form-wrap input_wrap user_name_container">
                                            <label>Last Name</label>
                                            <asp:Label ID="lblLastName" runat="server" class="user_name" TabIndex="1" placeholder="eg. Tom"></asp:Label>
                                            <asp:TextBox ID="txtLastName" runat="server" class="user_name" TabIndex="1" placeholder="Last Name"></asp:TextBox>
                                        </div>
                                        <div class="form-wrap input_wrap user_email_container">
                                            <label>Email</label>
                                            <asp:Label ID="lblEmail" runat="server" class="user_email" TabIndex="1" placeholder="eg. xyz@abc.com"></asp:Label>
                                            <asp:TextBox ID="txtEmail" runat="server" class="user_email" TabIndex="1" placeholder="eg. xyz@abc.com"></asp:TextBox>
                                        </div>
                                        <div class="form-wrap input_wrap user_mobile_container">
                                            <label>Mobile</label>
                                            <asp:Label ID="lblPhone" runat="server" placeholder="eg. 98******00"></asp:Label>
                                        </div>

                                        <asp:Button ID="btnUpdate" runat="server" class="btn loginOtp update_profile btn_style" TabIndex="3" Text="Update Profile" />
                                        <asp:Button ID="btnSave" runat="server" class="btn loginOtp update_profile btn_style" TabIndex="3" Text="Save Profile" OnClick="btnSave_Click" />
                                    </div>
