                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtcheckin" runat="server" class="form-control border-input" ReadOnly></asp:TextBox>
                                            <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtcheckin" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtcheckout" runat="server" class="form-control border-input" ReadOnly></asp:TextBox>
                                            <ajaxToolkit:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txtcheckout" />
                                        </div>
                                    </div>
                                </div>
