...
<body>
    <header id="topbar">
	<img class="logo" src="img/final_logo2.png" width="170" height="70"/>
</header>
<br/><br/><br/>
	...
	<div class="col-xs-12">
			...
			<div class="col-xs-12">
				...
				<br/><br/>
						        ...
						        <form id="user_details" method="post" name="form">
								        ...
								        <br/>
								         	<div class="col-sm-3 col-md-3 col-xs-12">
							        				...
							        				<p>The cvv number is printed <br>on the back of the card.</p>
						        				</div>
						       				</div>
						        				<br/>
                    ...
                    <%--      <asp:Button ID="pay" runat="server"   Text="Pay" OnClick="pay_Click"   />--%>
                          <asp:LinkButton ID="pay1" runat="server" Text="pay"  OnClick="pay1_Click"></asp:LinkButton>
				      </div>
		...
		<br/>
		<p><span class="glyphicon glyphicon-lock"></span>&nbsp;<span style="padding-top: 40px !important;">100% safe and secure payment</span> <img src="img/secure.png" width="110" height="70" style="float: right;"></p>
