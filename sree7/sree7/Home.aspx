...
<body>
    <form runat="server" id="frn2">
        <%--<div class="banner-top">
            ...
            <div class="contact-bnr-w3-agile">
                <ul>
                    <li><i class="fa fa-envelope" aria-hidden="true"><a href="mailto:sri7inn@gmail.com" style="box-sizing: border-box; text-align: left; outline: 0px; margin: 0px; text-decoration: underline; color: inherit; cursor: pointer; word-break: break-word; word-wrap: break-word; font-family: Lato; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-indent: 0px; text-transform: none; white-space: pre-wrap; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px;">sri7inn@gmail.com</a></i></li>
                    <li>+91 9985199522</li>
            ...
            <div class="container">
                <nav class="navbar navbar-default">
                    <div class="navbar-header navbar-left">
                        ...
                        <h1><a class="navbar-brand" href="Home.aspx">Sri7 <span>Inn</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p>
                        </a></h1>
                    </div>
        ...
        <div id="availability-agileits">
            ...
            <div class="col-md-9 book-form errorMessages">
                ...
                <div class="">
                    <asp:Button ID="submit" runat="server" Text="Check Availability" OnClick="submit_Click" OnClientClick="javascript:return RoomCheck()" Font-Size="Large" Font-Bold="true" Height="147px" Width="247px" />
                </div>
                <%-- </form>--%>
            </div>
            <div class="clearfix"></div>
	...
	<div class="container">
        ...
        <script type="text/javascript">
            function RoomCheck() {
                debugger
                var txtCheckIn, txtCheckOut, txtDDlRoom;
                ...
                if (txtCheckIn == 'Select Date' && txtCheckOut == 'Select Date' && txtDDlRoom == 'Select a Room') {
